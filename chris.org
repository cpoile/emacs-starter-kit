...
#+begin_src emacs-lisp
  ...
  (defun nrepl-common-hook ()
    (set-auto-complete-as-completion-at-point-function)
    (nrepl-turn-on-eldoc-mode))
  
  (add-hook 'nrepl-mode-hook 'nrepl-common-hook)
  (add-hook 'nrepl-interaction-mode-hook 'nrepl-common-hook)
...
#+end_src
*** Setup nrepl javadocs
The user-javadoc-alist variable is defined in the machine-specific username.el file.

#+source: nrepl-javadocs
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (add-hook 'Info-mode-hook 'remove-dos-eol)
#+end_src
** ERC
